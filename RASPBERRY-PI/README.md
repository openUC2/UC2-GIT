...
If you encounter problems with your prior-to-install working internet connection, please check the entries in /etc/hostapd/hostapd.conf, especially the [country code](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2), and replace by something appropriate if something  
obviously appears to be rubbish. Changes take effect after a reboot.
