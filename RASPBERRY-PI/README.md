...
If you encounter problems with your prior-to-install working internet connection, please check the [country code](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) and replace by something appropriate if obviously rubbish. Changes take effect after a reboot.
