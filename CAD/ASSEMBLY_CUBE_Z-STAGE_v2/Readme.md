...
* **The Lid (2x1)** where the Arduino + Electronics finds its place
* **The Cube (2x1)** which will be screwed to the Lid. Here all the functions (i.e. Mirrors, LED's etc.) find their place
* **The Z-Stage and Motor Holder** which moves the objective and holds the stepper motor 
* **The M4 to Motor Adapter (mech. Coupling)** which connects the Motor directly to an M4 screw which acts as a wormdrive 
* **The Objective Lens Thread Fixer** Kind of a retain ring which pushes the spiral arms closer to the objective lens
