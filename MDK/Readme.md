...
<p>
They are composed of one or more baseplates and modules with different functions. The list of available applications and modules that are necessary for building them can be found WHERE.
   </td>
  </tr>
  <tr>
   <td>ASSEMBLY BASE
