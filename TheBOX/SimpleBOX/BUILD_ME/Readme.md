# Building The SimpleBOX

This is a guide for building the [SimpleBOX](../SimpleBOX). If you were looking for another BOX version, [click here](../../).
...
Link - name of part             |  Amount |  Comment | Price per amount used
  ...
  [Screws](https://eshop.wuerth.de/Zylinderschraube-mit-Innensechskant-SHR-ZYL-ISO4762-88-IS25-A2K-M3X12/00843%20%2012.sku/de/DE/EUR/) |   ~120 pieces | M3×12, galvanized steel - ~50  pieces; M3×8, galvanized steel - ~50 pieces; M3×18, galvanized steel - 2 pieces; M3×30, not magnetic - 1 piece; M3 nut | ~10 €
...
[(05) Baseplate 4×1](./STL/05_Assembly_base_4x1.stl)  |  3 pieces
...
:-------------------------:|:-------------------------:|:-------------------------:
[(07) Z-Stage Focusing Insert](./STL/07_20_focus_inlet_linearflexure_v0_1.stl)  |  1 piece  | Rotate the part in your slicer before printing. Always print it laying on the flat side.
[(08) Z-Stage Bottom Plate](./STL/08_20_focus_inlet_plate_bottom_2.stl) |  1 piece   | The plate holds the gear and screw in position, allowing the only to rotate but not to wobble.
[(09) Z-Stage Top Plate](./STL/09_20_focus_inlet_plate_top_3.stl) |  1 piece   | The plate holds the gear and screw in position, allowing the only to rotate but not to wobble.
[(10) Z-Stage Gear](./STL/10_20_focus_inlet_gear.stl) |  1 piece   | Kindly borrowed from [openflexure](https://openflexure.org).
[(11) Z-Stage Objective Mount](./STL/11_30_focus_inlet_objective_mount_v7_7.stl) |  1 piece   | For mounting the objective lens (RMS thread).
[(12) Z-Stage Sample Plate](./STL/12_30_Z_Stage_Sampleplate_8.stl) |  1 piece   | It provides the optimal spacing between the objective lens and the sample.
[(13) Z-Stage Sample Clamp](./STL/13_30_Sampleclamp_generic_5mmMagnets.stl)  |  1 piece | To hold the microscope slide.
[(14) Eyepiece/flashlight mount](./STL/14_20_Cube_Insert_Holder_flashlight_eyepiece_v2.stl)  |  2 pieces | Diameter fits for the listed eyepiece and flashlight.
[(15) Mirror Holder 45° 30×30mm²](./STL/15_20_Cube_Insert_Mirror_Holder_30x30Mirror_v2.stl)  |  2 pieces | Size fits for the listed mirrors.
[(16) Generic Sample Holder](./STL/16_20_Cube_insert_Sample_holder.stl)  |  1 piece | In the SimpleBOX, it is used to hold the object in the projector setup.
[(17) Generic Sample Holder Clamp](./STL/17_20_Cube_Insert_Sample_clamp.stl)  |  1 piece | To fix the sample.
[(18) Lens Holder - Thick lens](./STL/18_20_Lens_mount_thick_lens.stl)  |  1 piece | Diameter fits for the listed lenses (25 mm). The thick holder is for the diverging lens.
[(19) Lens Holder - Thin lens](./STL/19_20_Lens_mount_Thin_lens.stl)  |  4 pieces | Diameter fits for the listed lenses (25 mm). The thin holder is for the converging lenses.
[(20) Lens Holder Clamp](./STL/20_20_Lens_mount_clamp.stl)  |  5 pieces | Diameter fits for the listed lenses (25 mm).
[(21) Smartphone Holder](./STL/21_30_Smartphone_Holder.stl)  |  1 piece | Which belongs together with the eyepiece cube.
...
[Z-Stage Cube](../../../CAD/ASSEMBLY_CUBE_Z-STAGE_mechanical_v2)|<img src="./IMAGES/z-stage.jpg" width="300">|1× mechanical Z-Stage with Sample Clamp
